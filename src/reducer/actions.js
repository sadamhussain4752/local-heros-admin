...
export const ORDER_LIST_STATUS_REQUEST = 'ORDER_LIST_STATUS_REQUEST';
export const ORDER_LIST_STATUS_SUCCESS = 'ORDER_LIST_STATUS_SUCCESS';
export const ORDER_LIST_STATUS_FAILURE = 'ORDER_LIST_STATUS_FAILURE';
export const ORDER_LIST_REQUEST_REFRESH = 'ORDER_LIST_REQUEST_REFRESH';
...
export const OrderStatusRequest = () => ({
  type: ORDER_LIST_STATUS_REQUEST,
});

export const OrderStatusSuccess = (data) => ({
  type: ORDER_LIST_STATUS_SUCCESS,
  payload: data,
});

export const OrderStatusFailure = (error) => ({
  type: ORDER_LIST_STATUS_FAILURE,
  payload: error,
});
...
export const OrderRequestRefresh = (data) => ({
  type: ORDER_LIST_REQUEST_REFRESH,
  payload: data,
